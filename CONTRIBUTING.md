...
After cloning the artmit repo, please follow the [Development guide](https://github.com/armitjs/armit/blob/main/README.md#development) in the README for instructions on how to get up and running locally.
